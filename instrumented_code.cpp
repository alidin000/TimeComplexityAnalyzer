...
using namespace std;
    ...
    cout << "Line 10: " << (clock() - start_time_10) / (double)CLOCKS_PER_SEC << " seconds" << endl;
    clock_t start_time_11 = clock();
    int main() {
    cout << "Line 11: " << (clock() - start_time_11) / (double)CLOCKS_PER_SEC << " seconds" << endl;
    clock_t start_time_12 = clock();
    }
    cout << "Line 12: " << (clock() - start_time_12) / (double)CLOCKS_PER_SEC << " seconds" << endl;
